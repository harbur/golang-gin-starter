...
import (
	...
	models "github.com/harbur/golang-startergin-/models"
)
...
func (o *HealthzOK) WithPayload(payload *models.Healthz) *HealthzOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the healthz o k response
func (o *HealthzOK) SetPayload(payload *models.Healthz) {
	o.Payload = payload
}
